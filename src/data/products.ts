...
const rawBearingProducts: BearingProduct[] = [
  ...
  },
  {
    ...
    nameEn: 'CORTECO 12019688B Heavy-Duty Cassette Seal 140x170 (Italy)',
    descriptionFa: 'کاسه نمد کاسِتی مولتی‌لیپ یکپارچه کورتکو ایتالیا با غلاف بوش داخلی و لبه‌های آب‌بندی چندگانه، برای محیط‌های غرق در گل و لای، لجن معادن و توپی چرخ تریلرهای سنگین.',
    descriptionEn: 'Integrated multi-lip cassette seal by CORTECO featuring internal running sleeve and multiple labyrinth dust barriers for extreme slurry and off-highway axles.',
    d: 140,
    D: 170,
    B: 16,
    weightKg: 0.38,
    ...
    speedGreaseRpm: 2500,
    speedOilRpm: 3800,
    cageMaterialFa: 'پوسته فولادی دوبل با پوشش ضدزنگ',
    cageMaterialEn: 'Double steel casing with anti-corrosion treatment',
    sealingFa: 'سیستم آب‌بندی چندلبه هزارتو با الاستومر مخصوص NBR',
    sealingEn: 'Multi-lip labyrinth seal with integrated wear sleeve',
    clearanceOptions: ['Heavy Heavy Cassette'],
    brands: ['Corteco', 'Freudenberg'],
    applicationsFa: ['توپی چرخ دامپتراک‌ها و بیل مکانیکی معدن', 'شفت پروانه میکسرهای دوغاب بتن', 'اکسل‌های سنگین تراکتور و کمباین'],
    applicationsEn: ['Mining Dumptruck Wheel Hubs', 'Slurry Mixer Propeller Shafts', 'Heavy Agricultural Drive Axles'],
    inStock: true,
    featured: true,
    schematicType: 'oil-seal',
    speedReferenceType: 'both',
  ...
  },
  {
    ...
    nameEn: 'CORTECO BABSL High-Pressure Oil Seal 45x65x8 (Up to 10 Bar)',
    descriptionFa: 'کاسه نمد تخصصی هیدرولیک با لبه کوتاه تقویت‌شده مقاوم در برابر فشارهای کاری پیوسته تا ۱۰ بار در پمپ‌های هیدرولیک دنده‌ای و پیستونی.',
    descriptionEn: 'Specialized high pressure rotary seal with short reinforced sealing lip designed to withstand continuous hydraulic pressures up to 10 bar.',
    d: 45,
    D: 65,
    B: 8,
    weightKg: 0.032,
    ...
    speedGreaseRpm: 4500,
    speedOilRpm: 7000,
    cageMaterialFa: 'اسکلت فلزی ضخیم مقاوم در برابر تغییر شکل تحت فشار',
    cageMaterialEn: 'Heavy gauge steel case for high pressure rigidity',
    sealingFa: 'لاستیک NBR تقویت‌شده با لبه فشاری کوتاه',
    sealingEn: 'Pressure-resistant reinforced NBR with short lip',
    clearanceOptions: ['DIN 3760 BABSL'],
    brands: ['Corteco', 'Freudenberg'],
    applicationsFa: ['هیدروموتورهای اوربیتال و پیستونی', 'پمپ‌های هیدرولیک دنده‌ای فشار قوی', 'محرک‌های فرمان هیدرولیک'],
    applicationsEn: ['Orbital & Piston Hydraulic Motors', 'High Pressure Gear Pumps', 'Hydraulic Power Steering Drives'],
    inStock: true,
    featured: false,
    schematicType: 'oil-seal',
    speedReferenceType: 'both',
